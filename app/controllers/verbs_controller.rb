class VerbsController < ApplicationController
  ...
  def index
    ...
    unless params[:category_id].nil?
      @verbs = Verb.where(category_id: params[:category_id])
    end
  ...
  def create
    ...
    respond_to do |format|
      if @verb.save
        format.html { redirect_to verbs_url, notice: 'Verb was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @verb.update(verb_params)
        format.html { redirect_to verbs_url, notice: 'Verb was successfully updated.' }
  ...
  private
    ...
    def verb_params
      params.require(:verb).permit(:description, :category_id)
    end
end
