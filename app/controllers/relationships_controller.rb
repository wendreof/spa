class RelationshipsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @relationship.update(relationship_params)
        format.html { redirect_to relationships_url, notice: 'Relationship was successfully updated.' }
  ...
  private
    ...
    def relationship_params
      params.require(:relationship).permit(:attitudinal_skill_id, :specific_skill_id, :category_id, :activity_id)
    end
end
